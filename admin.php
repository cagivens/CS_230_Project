            ...
            <div class="my-auto upload-container">
                <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <img src="images/soof.jpg" onclick="triggered()" id="gallery-display">
                        <input class="form-control" style="display: none;" type="file" name="gallery-image" id="gallery-image" onchange="preview(this)" />
                        <input type="text" name="title" id="title" class="form-control" placeholder="title" required />
                    </div>
                    <div class="form-group">
                        <textarea name="description" id="descript" cols="30" rows="3" placeholder="Description" style="text-align: center;">
                </textarea>
                    </div>
                    <div class="form-group">
